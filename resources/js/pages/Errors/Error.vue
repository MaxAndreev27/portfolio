...
onMounted(() => {
    if (scene.value) {
        new Parallax(scene.value, {
            relativeInput: true,
            hoverOnly: true,
            inputElement: document.getElementById('scene'),
        });
    }
});
</script>
...
<template>
    ...
    <section class="wrapper">
        <div class="container">
            <div ref="scene" id="scene" class="scene" data-hover-only="false">
                ...
                <p class="p404" data-depth="0.50">{{ status }}</p>
                <p class="p404" data-depth="0.10">{{ status }}</p>
            </div>
            ...
            <div class="text">
                <article>
                    ...
                    <Link :href="home()" as="button">To Main Page</Link>
                </article>
            </div>
        </div>
    </section>
